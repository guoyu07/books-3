<template>
    <div class="book-list">
        <div class="book-item" v-for="book in books" @click="$router.push({name:'reader', params: {book_id:'53a2c4c5fda0a68d82ff40d6'}})">
    ...
    module.exports = {
        ...
        methods    : {
            requestList () {
                var self = this;
                var postData = {
                    'ids' : ['53a36d86117d2e5e6e9be6f8', '53855a750ac0b3a41e00c7e6']
                };
                self.$http.post('/api/source/book-list', postData).then(function(res) {
